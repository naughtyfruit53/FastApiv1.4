...
try:
    ...
    print(f"Error including organizations router: {str(e)}")  # Print to console in case file logging fails
    raise  # Raise to stop server if include fails, to force noticing the issue
