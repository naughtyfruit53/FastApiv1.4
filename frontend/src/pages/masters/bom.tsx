...
const BOMManagement: React.FC = () => {
  ...
  const createMutation = useMutation({
    mutationFn: (data: BOM) => api.post('/bom', data),
    onSuccess: () => {
              ...
              <Autocomplete
                ...
                renderInput={(params) => (
                  <TextField
                    ...
                    helperText={errors.output_item_id?.message}
                  />
                )}
              />
            </Grid>
              ...
              <Grid size={12} key={field.id}>
                <Paper sx={{ p: 2, mb: 2 }}>
                  <Grid container spacing={2}>
                    ...
                    <Grid size={2}>
                      <TextField
                        {...control.register(`components.${index}.quantity_required` as const, { required: true, min: 0.01 })}
                        label="Quantity"
                        type="number"
                        fullWidth
                        size="small"
