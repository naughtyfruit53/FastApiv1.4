            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              ...
              <Box sx={{ 
                ...
                <Typography variant="body2" color="text.secondary">
                  • A new organization will be created with the provided details<br/>
                  • An org super admin account will be set up with the primary email<br/>
                  • A temporary password will be generated and displayed once<br/>
                  • A welcome email with login credentials will be sent to the org super admin<br/>
                  • You will remain logged in as the current super admin<br/>
                  • The org super admin must log in separately and change their password<br/>
                  • The organization will be ready to add users and configure settings
                </Typography>
              </Box>
            </form>
          )}
