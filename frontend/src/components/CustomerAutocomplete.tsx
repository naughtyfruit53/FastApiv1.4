...
const CustomerAutocomplete: React.FC<CustomerAutocompleteProps> = ({
  ...
  // Debounced search function (not used, keeping for reference)
  const _debouncedSearch = useCallback((searchTerm: string) => {
    // This is replaced by the useQuery implementation above
